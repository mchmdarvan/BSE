...
public class SmaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvSMA = findViewById(R.id.rvBukuSMA);
    ...
    public void getContents(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.getContents,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        rvSMA.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                        bookAdapter = new BookAdapterVertical(bookList);
                        rvSMA.setAdapter(bookAdapter);
                        bookAdapter.setOnItemClickCallback(new BookAdapterVertical.OnItemClickCallback() {
                            @Override
                            public void OnItemClick(Book data) {
                                Intent move = new Intent(SmaActivity.this, DetailBukuActivity.class);
        ...
        })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("levelid", "56217b714e4344dba0be0cc22b08ccc9");
                return params;
            }
            @Override
