...
public class BukuBaruActivity extends AppCompatActivity {

    SharedPreferences sharedPreferences;
    RecyclerView rvTerbaru;
    List<Book> bookList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvTerbaru = findViewById(R.id.rvTerbaru);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.getContents,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        rvTerbaru.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                        bookAdapter = new BookAdapterVertical(bookList);
                        rvTerbaru.setAdapter(bookAdapter);
                        bookAdapter.setOnItemClickCallback(new BookAdapterVertical.OnItemClickCallback() {
                            @Override
                            public void OnItemClick(Book data) {
                                Intent move = new Intent(BukuBaruActivity.this, DetailBukuActivity.class);
