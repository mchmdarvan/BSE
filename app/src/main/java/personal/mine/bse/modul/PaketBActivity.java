...
public class PaketBActivity extends AppCompatActivity {

    SharedPreferences sharedPreferences;
    RecyclerView rvPaketB;
    List<Book> bookList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvPaketB = findViewById(R.id.rvPaketB);
    ...
    public void getContents(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.getContents,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        rvPaketB.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                        bookAdapter = new BookAdapterVertical(bookList);
                        rvPaketB.setAdapter(bookAdapter);
                        bookAdapter.setOnItemClickCallback(new BookAdapterVertical.OnItemClickCallback() {
                            @Override
                            public void OnItemClick(Book data) {
                                Intent move = new Intent(PaketBActivity.this, DetailBukuActivity.class);
        ...
        })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("levelid", "11dc0243a87048098adc2e6d7489ab0d");
                return params;
            }
            @Override
