...
public class BukuPopulerActivity extends AppCompatActivity {

    SharedPreferences sharedPreferences;
    RecyclerView rvTerpopuler;
    List<Book> bookList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buku_populer);
        sharedPreferences = getSharedPreferences("login", MODE_PRIVATE);
        rvTerpopuler = findViewById(R.id.rvTerpopuler);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.getContents,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        rvTerpopuler.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                        bookAdapter = new BookAdapterVertical(bookList);
                        rvTerpopuler.setAdapter(bookAdapter);
                        bookAdapter.setOnItemClickCallback(new BookAdapterVertical.OnItemClickCallback() {
                            @Override
                            public void OnItemClick(Book data) {
                                Intent move = new Intent(BukuPopulerActivity.this, DetailBukuActivity.class);
