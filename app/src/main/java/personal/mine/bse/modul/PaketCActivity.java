...
public class PaketCActivity extends AppCompatActivity {

    SharedPreferences sharedPreferences;
    RecyclerView rvPaketC;
    List<Book> bookList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvPaketC = findViewById(R.id.rvPaketC);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.getContents,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        rvPaketC.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                        bookAdapter = new BookAdapterVertical(bookList);
                        rvPaketC.setAdapter(bookAdapter);
                        bookAdapter.setOnItemClickCallback(new BookAdapterVertical.OnItemClickCallback() {
                            @Override
                            public void OnItemClick(Book data) {
                                Intent move = new Intent(PaketCActivity.this, DetailBukuActivity.class);
