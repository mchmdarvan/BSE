...
public class SmkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvSMK = findViewById(R.id.rvBukuSMK);
    ...
    public void getContents(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.getContents,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        rvSMK.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                        bookAdapter = new BookAdapterVertical(bookList);
                        rvSMK.setAdapter(bookAdapter);
                        bookAdapter.setOnItemClickCallback(new BookAdapterVertical.OnItemClickCallback() {
                            @Override
                            public void OnItemClick(Book data) {
                                Intent move = new Intent(SmkActivity.this, DetailBukuActivity.class);
        ...
        })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("levelid", "7a68ff4df69d419ba4a42396085b5567");
                return params;
            }
            @Override
